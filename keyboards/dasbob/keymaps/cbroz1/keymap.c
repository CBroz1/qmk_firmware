...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ALPHA] = LAYOUT_split_3x5_3(
      ...
      * ├───┼───┼───┼───┼───┤       ├───┼───┼───┼───┼───┤
      * │PSC│VDn│VUp│Pau│CLK│       │SCD│ ML│ MU│ MD│ MR│
      * └───┴───┴───┴───┴───┘       └───┴───┴───┴───┴───┘
      *           ┌───┐                   ┌───┐
      *           │REP├───┐           ┌───┤   │
      *           └───┤BSP├───┐   ┌───┤SPC├───┘
      ...
      *     HOLD Tab = Shift (for shift+enter)
    ...
    [_SYMBL] = LAYOUT_split_3x5_3(
        ...
        KC_PSCR,    VO_D,     VO_U,     TD(DA_7), TD(DA_8), MW_D,     MM_L,       MM_D,       MM_U,      MM_R,
                              KC_TRNS,  KC_TRNS,  TO(0),    KC_TRNS,  KC_MS_BTN1,  KC_TRNS
    ),
...
void dance_4_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        ...
        case DOUBLE_HOLD: register_code16(ST_MACRO_0); break;
...
void dance_4_reset(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[4].step) {
        ...
        case DOUBLE_HOLD: unregister_code16(ST_MACRO_0); break;
